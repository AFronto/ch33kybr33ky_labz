...
public class Field {
	...
	protected EnumMap<Direction, Field> neighbours; 				///iranyokkal allÃ­ithato tomb
	...
	/**
	 * Ez a fuggveny visszaadja a kért iranyban levo szomszedot
	 * @param d irany
	 ...
	 * @param d irany
	 * @return rekurzivan megkeresi és visszadja,hogy vegul tudunk e lepni
	 */
